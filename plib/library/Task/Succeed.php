...
//                return pm_Locale::lmsg('Syncronising All Domain');
                return ('Simulating a successful task');
            case static::STATUS_DONE:
                return ('Successful simulation of a successful task!');
            case static::STATUS_ERROR:
                return pm_Locale::lmsg('SyncError', ['id' => $this->getId()]);
            case static::STATUS_NOT_STARTED:
                return pm_Locale::lmsg('SyncPingError', ['id' => $this->getId()]);
        }
        return '';
    }
